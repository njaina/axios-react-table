...
import AddBtn from "./components/Modal";
// import { Table, UserList } from "./components/List/Table";
import { EmployeeList } from "./components/List";
// import { useIncrement } from "./components/helper";


// const App = () => {
//   const [state, incrementState] = useIncrement(0);

//   return (
//     <>
//       <h1>{state}</h1>
//       <button onClick={incrementState}>increment the value</button>
//     </>
//   )
// }
function App() {
